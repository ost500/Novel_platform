...
class MyPageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $recently_updated_favorites = NovelGroup::join('favorites', 'favorites.novel_group_id', '=', 'novel_groups.id')
            ->with('nicknames')->where([['favorites.user_id', '=', Auth::user()->id]])->latest('novel_groups.updated_at')->take(5)->get();
