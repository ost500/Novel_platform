	...
	$('.novels-user-nick-form').on('click', function(){
		bootbox.dialog({
			...
			message:'<div class="row"> ' + '<div class="col-md-12"> ' +
					...
					'<div class="col-md-4"> ' +
					'<input id="name" name="name" type="text" placeholder="필명을 입력해주세요." class="form-control input-md"> ' +
					'</div> ' +
					'</div> ' + '<div class="form-group"> ' +
					'<label class="col-md-4 control-label" for="awesomeness">메인필명</label> ' +
					'<div class="col-md-8"> <div class="form-block"> ' +
					'<label class="form-radio form-icon demo-modal-radio active"><input type="radio" autocomplete="off" name="awesomeness" value="1" checked> 예, 메인 필명입니다.</label>' +
					'<label class="form-radio form-icon demo-modal-radio"><input type="radio" autocomplete="off" name="awesomeness" value="0"> 아니오, 메인 필명이 아닙니다. </label> </div>' +
					'</div> </div>' + '</form> </div> </div><script></script>',
			buttons: {
				success: {
					label: "저장",
