        ...
        <div class="content" id="content">
                ...
                <div class="novel-detail-content">
                    ...
                    <div class="post">
                        <div class="post-header">
                            <h2 class="title">{{ $review->novel_groups->title }}</h2>
            ...
            <article class="bbs-view">
                ...
                <div class="bbs-view-btns">
                    ...
                    <div class="right-btns">
                        <a href="{{route('reader_reco').'?novel_group='.$review->novel_groups->id}}" class="btn btn--special">이 소설의 다른 추천 보기</a>
                        <a href="{{route('reader_reco').'?review_user='.$review->users->id}}" class="btn btn--special2">작성자의 다른 추천 보기</a>
                    </div>
                </div>
                <!-- 댓글목록 -->
