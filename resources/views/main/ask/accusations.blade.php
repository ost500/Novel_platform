                                ...
                                <div class="item-rows">
                                    ...
                                    <div class="input input--checklist">
                                        <label class="checkbox2">
                                            <input type="radio" name="category" value="광고"
                                                   checked><span>광고</span></label>
                                        <label class="checkbox2">
                                            <input type="radio" name="category"
                                                   value="개인정보 침해"><span>개인정보 침해</span></label>
                                        <label class="checkbox2">
                                            <input type="radio" name="category"
                                                   value="사이버 저작권 침해"><span>사이버 저작권 침해</span></label>
                                        <label class="checkbox2">
                                            <input type="radio" name="category" value="음란물"><span>음란물</span></label>
                                        <label class="checkbox2">
                                            <input type="radio" name="category" value="명예훼손 및 모욕"><span>명예훼손 및 모욕</span></label>
