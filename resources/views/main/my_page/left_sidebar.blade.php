        ...
        <ul class="lnb-depth1">
            ...
            <li>
                ...
                @if(Request::is('my_info/personal/*'))
                    <ul class="lnb-depth2">
                        <li><a class="{{Request::is('my_info/personal/post_manage')?"is-active":""}}"
                               href="{{ route('my_info.post_manage') }}">게시글 관리</a></li>
                        <li><a class="{{Request::is('my_info/personal/review_manage')?"is-active":""}}"
                               href="{{ route('my_info.review_manage') }}">추천 리뷰 관리</a></li>
