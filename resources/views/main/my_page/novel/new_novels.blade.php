                    ...
                    @foreach($new_novels as $new_novel )
                        <li>
                            ...
                            <ul class="author-new-work-list">
                                ...
                                <li>
                                    <div class="thumb"> <span><a
                                                    href="{{route('each_novel.novel_group',['id'=>$new_novel->id])}}"><img
                                                        src="/img/novel_covers/{{$new_novel->cover_photo}}"
                                                        alt="망의 연월"></a></span></div>
                                    <div class="post">
                                        <strong class="title"><a
                                                    href="{{route('each_novel.novel_group',['id'=>$new_novel->id])}}">{{str_limit($new_novel->title,20)}}</a></strong>
                                ...
                                @foreach($other_novels[$new_novel->user_id] as $other_novel )
                                    <li>
                                        <div class="thumb"><a
                                                    href="{{route('each_novel.novel_group',['id'=>$other_novel->id])}}"><img
                                                        src="/img/novel_covers/{{$other_novel->cover_photo}}"
                                                        alt="괴롭히고 싶다"></a></div>
                                        <div class="post">
                                            <strong class="title"><a
                                                        href="{{route('each_novel.novel_group',['id'=>$other_novel->id])}}">{{str_limit($other_novel->title,20)}}</a></strong>
