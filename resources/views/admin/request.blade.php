            ...
            <div id="demo-email-list" class="panel-body">
                ...
                <ul id="demo-mail-list" class="mail-list">
                    ...
                    <li class="mail-list-unread">
                        <div class="mail-from"><button  @if($men_to_men_request->status==0) class="btn btn-xs btn-danger" @else class="btn btn-xs btn-success"  @endif >@if($men_to_men_request->status==0) 대기 @else 완료  @endif</button></div>
