    ...
    <div class="cont_wrap" >
        ...
        <div id="received" >
            ...
            <div class="replst_btn_wrap2 padt30">
                <a  v-on:click="destroy()" class="replst_btn2" style="cursor:pointer"  @if(count($received_mails) == 0)  disabled @endif>삭제</a>
                <a  v-on:click="myBoxOrSpam('mybox')" class="replst_btn2" style="cursor:pointer"  @if(count($received_mails) == 0)  disabled @endif>보관</a>
                <a  v-on:click="myBoxOrSpam('spam')" class="replst_btn2" style="cursor:pointer"  @if(count($received_mails) == 0)  disabled @endif>차단</a>
                <a  href="{{route('m.accusations',['id'=>Auth::user()->id])}}" class="replst_btn2" @if(count($received_mails) == 0)  disabled @endif style="cursor:pointer">신고</a>
            </div>
