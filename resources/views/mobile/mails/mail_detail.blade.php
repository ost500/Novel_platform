...
<div class="container">
    <div class="cont_wrap">
        ...
        <div class="view_tit_box mart20" style="border-top:0;">
            <h2 class="view_tit">{{ $mail->mailboxs->subject }}
            </h2>
        ...
        @if($prev_mail != null)
            <div class="view_tit_box mart20">
                ...
                <a href="{{ route('mails.detail',['id'=>$prev_mail->id]) }}"> <span
                            class="view_tit"> {{str_limit($prev_mail->mailboxs->subject,25)}}</span></a>
        ...
        @if($next_mail != null)
            <div class="view_tit_box mart20">
                ...
                <a href="{{ route('mails.detail',['id'=>$next_mail->id]) }}">
                    <span class="view_tit">{{str_limit($next_mail->mailboxs->subject,25)}}</span></a>
