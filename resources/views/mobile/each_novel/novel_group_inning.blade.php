...
@section('content')
        ...
        <div class="cont_wrap" id="inning">
            ...
            <div class="">
                ...
                <div class="bokartic_wrap">
                    ...
                    <!-- 댓글 리스트 -->
                    <div id="comment_section" class="repl_lst_wrap" data-name="#comment">
                        <div class="replst_head">
                            <h3 class="mlist_tit4">댓글<span class="repcount">({{count($novel_group_inning->comments)}})</span></h3>
                            ...
                            <div class="sort_area">
                                ...
                                <a href="{{ route('each_novel.novel_group_inning', ['id' => $novel_group_inning->id]).'?order=older' }}"
                                   @if($order == 'older')  class="sort_btn sort_on"
                                ...
                                @foreach($novel_group_inning_comments as $novel_group_inning_comment)
                                    ...
                                    @foreach($novel_group_inning_comment['children'] as $novel_group_inning_comment_reply)
                                        <li class="repl_lst_re">
                                            <div class="replst_tit">{{$novel_group_inning_comment_reply->users->name}}
                                                <span
                        ...
                        @include('pagination_mobile', ['collection' => $novel_group_inning_comments, 'url' => route('each_novel.novel_group_inning',['id'=>$novel_group_inning->id])."?"])
                    </div>
                    <!-- 댓글 리스트 //-->
                </div>
                <!-- 페이지 내용 //-->
    ...
    <script type="text/javascript">
        ...
        $(function () {
            @if($page)
                $('html,body').animate({
                scrollTop: $("#comment_section").offset().top - 400
            });
            @endif
        });
