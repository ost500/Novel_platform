        ...
        @if (count($errors) > 0)
            ...
            <div class="content" id="content">
                ...
                <form name="ask_queston" id="ask_queston"
                      action="{{route('m.free_board.update',['id'=>$free_board->id])}}" method="post"
                    ...
                    <fieldset style="margin-top:10%;">
                        ...
                        <!-- 제목입력 -->
                        <input type="text" name="title" id="title" value="{{$free_board->title}}"
                        ...
                        <textarea class="repl_txtar mart15" rows="3" cols="30" name="content"
                                  id="content" placeholder="내용을 입력해주세요.">{{$free_board->content}}</textarea>
