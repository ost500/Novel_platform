...
@section('content')
    ...
    <div class="boxed" xmlns:v-el="http://www.w3.org/1999/xhtml">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="panel">
                            <form action="{{ route('novels.store') }}" method="post" enctype="multipart/form-data"
                                ...
                                <input hidden type="text" v-model="novel.novel_group_id" name="novel_group_id" v-el:custom @submit.prevent="submit">
                            <!--Static-->
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 text-center">
                                        <button type="submit" value="submit" class="btn btn-lg btn-primary">회차저장</button>
...
//                    var csrfToken = form.querySelector('input[name="_token"]').value;
                    ...
                    this.$http.post(action, this.novel)
                            .then(function (response) {
                                $.niftyNoty({
                                    type: 'purple',
                                    icon : 'fa fa-check',
